...
changes       | Array of SingleChange | Array of single changes within a batch change. A *SingleChange* can either be a [SingleAddChange](./batchchange-model#singleaddchange-attributes) or a [SingleDeleteChange](./batchchange-model#singledeletechange-attributes). |
